...
readTime: 9
faqs:
  - q: "Can you play real Mahjong online?"
    a: "Yes — real four-player Mahjong (not the tile-matching solitaire game) is available to play online. Platforms like Mahjo offer genuine multiplayer Mahjong where you draw, discard, claim tiles, and compete against real players or bots under authentic Mahjong rules. Real online Mahjong plays identically to in-person Mahjong, minus the physical tiles."
  - q: "Is online Mahjong the same as the tile-matching game on phones?"
    a: "No. The tile-matching game (often called Mahjong solitaire) is a completely different game that happens to use the same tiles. Real Mahjong is a four-player competitive game with draws, discards, claiming, and strategy. When looking for real Mahjong online, look for platforms that specify multiplayer or four-player Mahjong."
  - q: "Do you need to download anything to play Mahjong online?"
    a: "It depends on the platform. Mahjo runs in your browser with no download required — you can start a game immediately. Some platforms require app downloads. Browser-based play is the easiest way to get started, especially if you are new and not sure whether you will stick with it."
  - q: "Can you play Mahjong online with friends?"
    a: "Yes. Most real Mahjong platforms allow you to create private games and invite friends via a link or room code. This is one of the main advantages of online Mahjong — you do not need to coordinate four schedules and a physical location. Friends in different countries can sit at the same virtual table."
  - q: "How fast is online Mahjong compared to in-person?"
    a: "Online Mahjong is typically faster than in-person play. There is no tile shuffling, wall-building, or dealing time. Most platforms enforce turn timers, which keeps the pace brisk. A hand that might take 20 minutes in person often completes in 8–12 minutes online."
  - q: "Is online Mahjong good for learning?"
    a: "Yes — online Mahjong is one of the best ways to learn. You can play against bots at any time (no need to find three other people), the game handles rule enforcement automatically (so you cannot make illegal moves and immediately see what is and is not allowed), and you can play many more hands per week than in-person play allows."
---
...
[Mahjo](https://www.mahjo.app) is free, browser-based, and plays real Hong Kong-style Mahjong — no download, no account required to start.

**To play immediately:**
1. Go to [mahjo.app](https://www.mahjo.app)
2. Start a game — bot opponents fill any empty seats
3. Your 13 tiles appear; the dealer (East player) goes first
4. Click a tile in your hand, then Discard to throw it
5. When the claim window appears after a discard, select your claim or let it pass
...
Create a private room and share the link. Friends can join directly from their browser. No account needed.

## Tips for Online Play

**Use the discard history.** Most platforms show each player's discard pool clearly. Online, you have more time to read them than in a fast-paced in-person game — use it. See our [reading the table guide](/strategy/reading-the-table) for how to interpret discards.
...
1. Start a private room on Mahjo
2. Play the first hand slowly — use it to explain what is happening as it happens
3. Let the game enforce the rules so you do not have to be the rule police
4. After two or three hands, most players have the basic flow down
...
Ready to play? **[Start a game on Mahjo](https://www.mahjo.app)** — free, in your browser, no download.
